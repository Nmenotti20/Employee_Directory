...
For this project, I created an employee directory with React which required me to break up the application's UI into components, manage component state, and respond to user events. 
#### User Story

As a user, I want to be able to view my entire employee directory at once so that I have quick access to their information. It would be particularly helpful to be able to filter employees by name.
...
<ul>
    <li>Sort the table by at least one category</li><br>
